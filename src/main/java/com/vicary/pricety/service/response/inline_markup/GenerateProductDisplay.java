...
public class GenerateProductDisplay implements ProductDisplayer {

    private String chatId;
    private List<Product> products;
    private final QuickSender quickSender;

    public GenerateProductDisplay(@NonNull List<Product> products, @NonNull String chatId) {
        this.products = products;
        this.chatId = chatId;
        this.quickSender = new QuickSender();
    }

    public GenerateProductDisplay(@NonNull List<Product> products, @NonNull String chatId, QuickSender quickSender) {
        this.products = products;
        this.chatId = chatId;
        this.quickSender = quickSender;
    }

    public GenerateProductDisplay() {
        this.quickSender = new QuickSender();
    }
    ...
    private void setTitle(StringBuilder sb) {
        sb.append("*").append(Messages.generateProduct("yourProducts")).append("*\n\n");
    }
    ...
    private String getSummaryMessage() {
        return "\u200E \n\n\n*" + Messages.generateProduct("select") + "*\\.";
    }

    private ReplyMarkup getReplyMarkup() {
        return InlineKeyboardMarkupFactory.getProductChoice(products, "-generate");
    }
}
