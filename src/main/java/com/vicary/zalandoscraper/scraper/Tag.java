...
class Tag {
    static class Zalando {
        static final String ONE_VARIANT_NAME = "span.sDq_FX._2kjxJ6.dgII7d.Yb63TQ";
        ...
        static final String LINK_VALID = "div._5qdMrS.VHXqc_.rceRmQ._4NtqZU.mIlIve";
        static final String SOLD_OUT = "Artykuł wyprzedany";
    ...
    static class Hebe {
        static final String IS_MULTI_VARIANT = "div.swatch__items.swatch__items";
        static final String GET_ALL_VARIANTS = "div.swatch__item.swatch__item";
