...
import com.vicary.zalandoscraper.api_object.File;
import com.vicary.zalandoscraper.api_object.RequestResponse;
import com.vicary.zalandoscraper.api_object.RequestResponseList;
import com.vicary.zalandoscraper.api_object.User;
import com.vicary.zalandoscraper.api_object.bot.BotShortDescription;
import com.vicary.zalandoscraper.api_object.bot.bot_command.BotCommand;
import com.vicary.zalandoscraper.api_object.chat.ChatAdministratorRights;
import com.vicary.zalandoscraper.api_object.chat.ChatInviteLink;
import com.vicary.zalandoscraper.api_object.games.GameHighScore;
import com.vicary.zalandoscraper.api_object.inline_query.SentWebAppMessage;
import com.vicary.zalandoscraper.api_object.message.Message;
import com.vicary.zalandoscraper.api_object.other.UserProfilePhotos;
import com.vicary.zalandoscraper.api_object.poll.Poll;
