...
class AllProductDisplay implements ProductDisplayer {
    ...
    public AllProductDisplay(@NonNull List<Product> products, @NonNull String chatId) {
    ...
    public AllProductDisplay(@NonNull List<Product> products, @NonNull String chatId, QuickSender quickSender, ThreadRandom threadRandom) {
        this.products = products;
        this.chatId = chatId;
