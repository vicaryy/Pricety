...
class EditProductDisplay implements ProductDisplayer {
    ...
    public EditProductDisplay(@NonNull List<Product> products, @NonNull String chatId) {
        this.products = products;
        this.chatId = chatId;
        this.quickSender = new QuickSender();
    }

    public EditProductDisplay(@NonNull List<Product> products, @NonNull String chatId, QuickSender quickSender) {
        this.products = products;
        this.chatId = chatId;
    ...
    private ReplyMarkup getReplyMarkup() {
        return InlineKeyboardMarkupFactory.getProductChoice(products, "-edit");
    }
}
